...
@Component({
  selector: 'app-camera-processor',
  templateUrl: './camera-processor.component.html',
  styleUrls: ['./camera-processor.component.css'],
})
export class CameraProcessorComponent implements OnInit {
